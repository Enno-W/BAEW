...
Eine Überprüfung der Voraussetzungen für die weitere Analyse erfolgte anhand von **visueller Inspektion von Histogrammen und Q-Q-Plots aller numerischen Variablen**, sowie Shapiro-Wilk-Tests der Normalität.
<!-- Include the figures in markdown?? -->
...
@tbl-stattable zeigt einen Überblick über deskriptive Statistiken aller relevanten Variablen.
...
Die Anzahl der abgeschlossenen Trainingseinheiten, von denen es insgesamt sechs in der Studie gab, weist eine extrem linksschiefe, nicht normalverteilte Verteilung auf, da viele Personen alle Einheiten beendet haben. Ein ähnliches Muster mit vielen hohen Werten weist die durchschnittliche wahrgenommene Zielerreichung auf. 
