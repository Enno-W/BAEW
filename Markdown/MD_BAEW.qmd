...
Auch bei niedrigem ICC ist ein HLM angemessen @nezlek2008introduction

icc_goal$ICC_adjusted


```{r}
#| label: tbl-hlmtable1
#| tbl-cap: Hlm tabelle 1.1
#| apa-note: \*p \< 0.05; \*\*p \< 0.01
