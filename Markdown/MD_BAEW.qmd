...
In dem bereinigten Datensatz befanden sich immer noch `r sum(is.na(df_less_na))` fehlende Werte, die per multipler Imputation [@Li2015] per *predictive mean matching* mit 5 Iterationen geschätzt wurden.
